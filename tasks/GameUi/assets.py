...
class GameUiAssets:
	...
	# 闲庭设置
	I_CHECK_MAIN_SET = RuleImage(roi_front=(255,37,41,36), roi_back=(214,6,120,100), threshold=0.8, method="Template matching", file="./tasks/GameUi/page/page_check_main_set.png")
